...
# set angle
execute store result entity @s Rotation[0] float 1 run scoreboard players get .input psm.maths.interface

# tp ^1000 instead of ^1 for the output precision
execute at @s run tp ^ ^ ^1000

# get the output
execute store result score .output psm.maths.interface run data get entity @s Pos[2]
