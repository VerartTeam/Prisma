...
scoreboard players set #-1000000 psm.maths.const -1000000
scoreboard players set #-100000 psm.maths.const -100000
scoreboard players set #-10000 psm.maths.const -10000
scoreboard players set #-1000 psm.maths.const -1000
scoreboard players set #-100 psm.maths.const -100
scoreboard players set #-10 psm.maths.const -10
scoreboard players set #-1 psm.maths.const -1
scoreboard players set #0 psm.maths.const 0
scoreboard players set #1 psm.maths.const 1
scoreboard players set #10 psm.maths.const 10
scoreboard players set #100 psm.maths.const 100
scoreboard players set #1000 psm.maths.const 1000
